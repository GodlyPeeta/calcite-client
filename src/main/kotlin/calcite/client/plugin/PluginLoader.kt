...
internal class PluginLoader(
    ...
    init {
        ...
        calcite.client.CalciteMod.LOG.debug(info.toString())
    }
    ...
    fun verify(): Boolean {
        ...
        calcite.client.CalciteMod.LOG.info("SHA-256 checksum for ${file.name}: $result")

        return checksumSets.contains(result)
    }

    fun load(): Plugin {
        if (calcite.client.CalciteMod.ready && !info.hotReload) {
