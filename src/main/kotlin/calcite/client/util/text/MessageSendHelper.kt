package calcite.client.util.text
...
import calcite.client.util.TaskState
...
object MessageSendHelper {
    ...
    private fun coloredName(colorCode: Char) = "&7[&$colorCode" + calcite.client.CalciteMod.NAME + "&7] &r"
