...
import calcite.client.setting.groups.SettingGroup
import calcite.client.setting.groups.SettingMultiGroup
...
abstract class AbstractConfig<T : Any>(
    ...
    override fun load() {
        try {
            ...
            calcite.client.CalciteMod.LOG.warn("Failed to load latest, loading backup.")
