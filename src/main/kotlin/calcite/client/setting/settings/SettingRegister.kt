package calcite.client.setting.settings

import calcite.client.setting.settings.impl.number.DoubleSetting
import calcite.client.setting.settings.impl.number.FloatSetting
import calcite.client.setting.settings.impl.number.IntegerSetting
import calcite.client.setting.settings.impl.other.BindSetting
import calcite.client.setting.settings.impl.other.ColorSetting
import calcite.client.setting.settings.impl.primitive.BooleanSetting
import calcite.client.setting.settings.impl.primitive.EnumSetting
import calcite.client.setting.settings.impl.primitive.StringSetting
import calcite.client.util.Bind
