...
import calcite.client.gui.rgui.InteractiveComponent
...
import calcite.commons.extension.sumByFloat
...
open class ListWindow(
    ...
    var hoveredChild: Component? = null
        private set(value) {
            ...
            (field as? InteractiveComponent)?.onLeave(AbstractCalciteGui.getRealMousePos())
            (value as? InteractiveComponent)?.onHover(AbstractCalciteGui.getRealMousePos())
            field = value
        }
