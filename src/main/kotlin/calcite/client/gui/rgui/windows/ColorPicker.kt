...
import calcite.client.gui.rgui.component.Button
import calcite.client.gui.rgui.component.SettingSlider
import calcite.client.gui.rgui.component.Slider
...
object ColorPicker : TitledWindow("Color Picker", 0.0f, 0.0f, 200.0f, 200.0f, SettingGroup.NONE) {
    ...
    private var hoveredChild: Slider? = null
        set(value) {
            ...
            field?.onLeave(AbstractCalciteGui.getRealMousePos())
            value?.onHover(AbstractCalciteGui.getRealMousePos())
            field = value
        }
