...
import calcite.client.event.events.OnUpdateWalkingPlayerEvent
...
import calcite.client.mixin.extension.id
import calcite.client.mixin.extension.packetAction
...
import calcite.client.util.combat.CrystalUtils.canPlaceCollide
import calcite.client.util.combat.CrystalUtils.getCrystalBB
import calcite.client.util.combat.CrystalUtils.getCrystalList
import calcite.client.util.items.*
import calcite.client.util.math.RotationUtils
import calcite.client.util.math.RotationUtils.getRotationTo
import calcite.client.util.math.RotationUtils.getRotationToEntity
...
import calcite.client.util.math.VectorUtils.toVec3dCenter
...
import calcite.client.util.world.getClosestVisibleSide
