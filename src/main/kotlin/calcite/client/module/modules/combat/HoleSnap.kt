...
import calcite.client.util.MovementUtils.isCentered
import calcite.client.util.MovementUtils.resetMove
...
import calcite.commons.extension.toRadian
    ...
    init {
        ...
        safeListener<RenderWorldEvent>(1) {
            holePos?.let {
                ...
                val posFrom = EntityUtils.getInterpolatedPos(player, CalciteTessellator.pTicks())
