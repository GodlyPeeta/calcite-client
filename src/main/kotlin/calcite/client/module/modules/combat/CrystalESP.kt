...
import calcite.client.util.Quad
...
import calcite.client.util.graphics.ProjectionUtils
...
internal object CrystalESP : Module(
    ...
    private fun getAnimationProgress(prevProgress: Float, progress: Float): Float {
        val interpolated = prevProgress + (progress - prevProgress) * CalciteTessellator.pTicks()
