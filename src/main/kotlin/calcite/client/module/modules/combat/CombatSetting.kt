...
import calcite.client.module.modules.player.AutoEat
...
import calcite.client.util.combat.CrystalUtils.getPlacePos
import calcite.client.util.graphics.*
import calcite.client.util.math.RotationUtils.getRelativeRotation
    ...
    init {
        listener<RenderOverlayEvent> {
            ...
            CombatManager.target?.let {
                ...
                val posCurrent = EntityUtils.getInterpolatedPos(it, CalciteTessellator.pTicks())
    ...
    private fun SafeClientEvent.filterByFilter(listIn: LinkedList<EntityLivingBase>): LinkedList<EntityLivingBase> {
        when (filter.value) {
            ...
            TargetFilter.MANUAL -> {
                ...
                val eyePos = player.getPositionEyes(CalciteTessellator.pTicks())
