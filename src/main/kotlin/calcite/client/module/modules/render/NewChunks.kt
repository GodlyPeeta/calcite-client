...
import calcite.client.util.EntityUtils.getInterpolatedPos
...
internal object NewChunks : Module(
    ...
    init {
        ...
        safeListener<RenderWorldEvent> {
            ...
            val y = yOffset.toDouble() + if (relative) getInterpolatedPos(player, CalciteTessellator.pTicks()).y else 0.0
