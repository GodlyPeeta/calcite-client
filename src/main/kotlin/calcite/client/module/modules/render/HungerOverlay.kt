...
import calcite.client.util.items.foodValue
import calcite.client.util.items.saturation
...
internal object HungerOverlay : Module(
    ...
    private val icons = ResourceLocation("calcite/textures/hungeroverlay.png")
