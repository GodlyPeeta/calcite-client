...
import calcite.client.util.EntityUtils.getTargetList
...
import calcite.client.util.graphics.ShaderHelper
...
internal object ESP : Module(
    ...
    private fun drawEntities() {
        ...
        for (entity in entityList) {
            ...
            val partialTicks = CalciteTessellator.pTicks()
    ...
    private fun drawShader() {
        ...
        shaderHelper.shader?.render(CalciteTessellator.pTicks())
