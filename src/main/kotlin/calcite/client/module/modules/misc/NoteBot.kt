...
import calcite.client.util.world.getMiningSide
...
internal object NoteBot : Module(
    ...
    description = "Plays music with note blocks; put .mid or .nbs songs in .minecraft/calcite/songs"
) {
    ...
    private fun loadSong() {
        defaultScope.launch(Dispatchers.IO) {
            val path = "${calcite.client.CalciteMod.DIRECTORY}songs/$songName"
