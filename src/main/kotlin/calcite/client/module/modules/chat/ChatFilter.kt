...
internal object ChatFilter : Module(
    ...
    private val file = File(calcite.client.CalciteMod.DIRECTORY + "chat_filter.txt")
    ...
    init {
        onEnable {
            try {
                ...
                MessageSendHelper.sendErrorMessage("$chatName Couldn't find a file called '&7chat_filter.txt&f' inside your '&7.minecraft/calcite&f' folder, disabling")
                disable()
