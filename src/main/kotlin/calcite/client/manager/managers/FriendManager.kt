...
object FriendManager : Manager {
    ...
    private val file = File(calcite.client.CalciteMod.DIRECTORY + "friends.json")
    ...
    fun loadFriends(): Boolean {
        ...
        return try {
            ...
            calcite.client.CalciteMod.LOG.info("Friend loaded")
            true
        } catch (e: Exception) {
            calcite.client.CalciteMod.LOG.warn("Failed loading friends", e)
            false
        }
    }
    ...
    fun saveFriends(): Boolean {
        return try {
            ...
            calcite.client.CalciteMod.LOG.info("Friends saved")
            true
        } catch (e: Exception) {
            calcite.client.CalciteMod.LOG.warn("Failed saving friends", e)
            false
        }
    }
