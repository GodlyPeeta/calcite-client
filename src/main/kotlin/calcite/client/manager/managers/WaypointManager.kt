...
object WaypointManager : Manager {
    ...
    private val file = File(calcite.client.CalciteMod.DIRECTORY + "waypoints.json")
    ...
    fun loadWaypoints(): Boolean {
        ...
        val success = try {
            ...
            calcite.client.CalciteMod.LOG.info("Waypoint loaded")
            true
        } catch (e: Exception) {
            calcite.client.CalciteMod.LOG.warn("Failed loading waypoints", e)
            false
        }
    ...
    fun saveWaypoints(): Boolean {
        return try {
            ...
            calcite.client.CalciteMod.LOG.info("Waypoint saved")
            true
        } catch (e: Exception) {
            calcite.client.CalciteMod.LOG.warn("Failed saving waypoint", e)
            false
        }
    }
    ...
    fun add(locationName: String): Waypoint {
        ...
        return if (pos != null) {
            ...
            calcite.client.CalciteMod.LOG.error("Error during waypoint adding")
