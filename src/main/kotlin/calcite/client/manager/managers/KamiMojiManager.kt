...
import calcite.client.util.graphics.texture.MipmapTexture
...
object KamiMojiManager : Manager {
    ...
    private const val directory = "${calcite.client.CalciteMod.DIRECTORY}emojis"
    ...
    private val job = defaultScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            calcite.client.CalciteMod.LOG.warn("Failed to check emoji update", e)
        }
        ...
        calcite.client.CalciteMod.LOG.info("KamiMoji Initialized")
    }
    ...
    private fun streamToJson(stream: InputStream): JsonObject? {
        return try {
            ...
            calcite.client.CalciteMod.LOG.warn("Failed to parse emoji version Json", e)
            null
        }
    }
    ...
    private fun loadEmoji(name: String) {
        ...
        try {
            ...
            calcite.client.CalciteMod.LOG.warn("Failed to load emoji", e)
        }
    }
