...
object KamiMojiManager : Manager {
    ...
    private const val directory = "${CalciteMod.DIRECTORY}emojis"
    ...
    private val job = defaultScope.launch(Dispatchers.IO) {
        ...
        try {
            ...
            CalciteMod.LOG.warn("Failed to check emoji update", e)
        }
        ...
        CalciteMod.LOG.info("KamiMoji Initialized")
    }
    ...
    private fun streamToJson(stream: InputStream): JsonObject? {
        return try {
            ...
            CalciteMod.LOG.warn("Failed to parse emoji version Json", e)
            null
        }
    }
    ...
    private fun loadEmoji(name: String) {
        ...
        try {
            ...
            CalciteMod.LOG.warn("Failed to load emoji", e)
        }
    }
