...
object FriendManager : Manager {
    ...
    private val file = File(CalciteMod.DIRECTORY + "friends.json")
    ...
    fun loadFriends(): Boolean {
        ...
        return try {
            ...
            CalciteMod.LOG.info("Friend loaded")
            true
        } catch (e: Exception) {
            CalciteMod.LOG.warn("Failed loading friends", e)
            false
        }
    }
    ...
    fun saveFriends(): Boolean {
        return try {
            ...
            CalciteMod.LOG.info("Friends saved")
            true
        } catch (e: Exception) {
            CalciteMod.LOG.warn("Failed saving friends", e)
            false
        }
    }
