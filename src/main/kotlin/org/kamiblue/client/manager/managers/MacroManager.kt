...
object MacroManager : Manager {
    ...
    private val file get() = File(CalciteMod.DIRECTORY + "macros.json")
    ...
    fun loadMacros(): Boolean {
        ...
        return try {
            ...
            CalciteMod.LOG.info("Macro loaded")
            true
        } catch (e: Exception) {
            CalciteMod.LOG.warn("Failed loading macro", e)
            false
        }
    }
    ...
    fun saveMacros(): Boolean {
        return try {
            ...
            CalciteMod.LOG.info("Macro saved")
            true
        } catch (e: Exception) {
            CalciteMod.LOG.warn("Failed saving macro", e)
            false
        }
    }
