...
object WaypointManager : Manager {
    ...
    private val file = File(CalciteMod.DIRECTORY + "waypoints.json")
    ...
    fun loadWaypoints(): Boolean {
        ...
        val success = try {
            ...
            CalciteMod.LOG.info("Waypoint loaded")
            true
        } catch (e: Exception) {
            CalciteMod.LOG.warn("Failed loading waypoints", e)
            false
        }
    ...
    fun saveWaypoints(): Boolean {
        return try {
            ...
            CalciteMod.LOG.info("Waypoint saved")
            true
        } catch (e: Exception) {
            CalciteMod.LOG.warn("Failed saving waypoint", e)
            false
        }
    }
    ...
    fun add(locationName: String): Waypoint {
        ...
        return if (pos != null) {
            ...
            CalciteMod.LOG.error("Error during waypoint adding")
