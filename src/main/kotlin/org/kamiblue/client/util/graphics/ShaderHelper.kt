    ...
    init {
        shader = when {
            !OpenGlHelper.shadersSupported -> {
                CalciteMod.LOG.warn("Shaders are unsupported by OpenGL!")
                null
            }

            isIntegratedGraphics -> {
                CalciteMod.LOG.warn("Running on Intel Integrated Graphics!")
                null
            }
                ...
                try {
                    ...
                    CalciteMod.LOG.warn("Failed to load shaders")
                    e.printStackTrace()
